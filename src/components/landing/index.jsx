...
un message te signalant le resultat du legit check. Un certificat d’authenticité sera inséré dans ta boîte à chaussures ainsi qu’un jeton scellé à ta paire. 
      ...
      {/* Pricing */}
      <Grid container direction="column" style={{margin: 'auto 100px', flexWrap: 'nowrap', background: 'linear-gradient(180deg, #F8F8FF 10.26%, rgba(248, 248, 255, 0) 107.14%)', borderRadius: 25}} justify="center" alignItems="center">
